...
void generateHuffmanCodes(TreeNode *root, string currentCode = "")
{
    if (root != nullptr)
    {
        if (root->symbol != '\0')
        {
            ...
            cout << "Symbol: " << root->symbol << ", Huffman Code: " << currentCode << endl;
        }
    ...
    while (true)
    {
        ...
        case 3:
                if (textoIngresado && !algoritmoHuffmanAplicado) {
                    ...
                    cout << "Huffman strings:" << endl;

                    for (char c : userInput)
                    {
                        cout << "Symbol: " << c << ", Huffman String: " << getHuffmanString(root, c) << endl;
                    }
                    for (char c : userInput)
                    {
                    ...
                    cout << "Concatenated Huffman string: "<< "\n" << huffmanString << endl;
        ...
        case 4: 
                ...
                if (textoIngresado) {
                        if(algoritmoHuffmanAplicado == true){
                            cout << "Concatenated Huffman string: "<< huffmanString << endl;
